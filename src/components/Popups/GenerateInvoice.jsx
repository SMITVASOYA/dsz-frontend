...
function GenerateInvoice({ visible, close }) {
  ...
  const [metadata, setmetadata] = useState({
    date: date,
    suppliers_ref_no: FY,
    offer_validity: "500 Days",
    payment_terms: "300% Advanced payment",
  ...
  // useEffect(() => {
  //   if (QueryId && NewInvoice) {
  //     dispatch(fetchLatestQuotation(QueryId));
  //   }
  // }, [NewInvoice]);

  useEffect(() => {
    if (latestQuotation && Object.keys(latestQuotation)?.length > 0) {
      setmetadata(latestQuotation?.metadata);
      SetProduct(latestQuotation?.products);
      SetRProduct(latestQuotation?.recommend_products);
      SetTACList(latestQuotation?.TAC);
      setClient(latestQuotation?.client);
    }
  }, [latestQuotation]);
  ...
  const HandelModelSelect = (i, element, e) => {
    console.log(productDetails, "Product Details 2");
    let val = e.target.value;
    ...
    preProduct[i]["width"] = productDetails[element.name].products[val].Width
      ...
      : "NA";
    preProduct[i]["length"] = productDetails[element.name].products[val].Length
  ...
  // ------ for details to be shown (product)--------
  ...
  // Products details state handler
  ...
  // Input Handel for additional things ex width, height, rate, unit (product)
  ...
  // recommended delete button handler
  ...
  // recommended copy button handler
  const addRFields = () => {
    SetRProduct([...RProductList, {}]);
  };

  // recommended - select products handler
  ...
  // recommended product type handler
  ...
  // ------ for details to be shown (recommended product) --------
  ...
  // Recommended Products details state handler
  ...
  // Input Handel for additional things ex width, height, rate, unit (recommended)
  ...
  // Term and Condition Handel (recommended)
  ...
  const HandelSubmit = async () => {
    ...
    pevData["client_id"] = SetData(pevData);
    ...
    if (pevData.client.name === "") {
      ...
      pevData.sellerDetail.name === "" ||
      pevData.sellerDetail.mobile === ""
    ) {
      error = "Seller's Details are not set!";
      message = "Please Fill Seller's Data......";
    } else if (
      pevData.buyerDetail.name === "" ||
      pevData.buyerDetail.mobile === ""
    ) {
      error = "Buyer's Detail Details are not set!";
      message = "Please Fill Buyer's Data...";
    ...
    if (error !== "") {
      ...
      await fetch(
        `http://128.199.26.175:3006/generate/createInvoice`,
        requestOptions
      )
      ...
      <div className="w-[98%] md:w-[1100px] h-[82%] md:h-[85%] overflow-y-scroll  bg-bg rounded-md">
        ...
        <div className="px-5 md:px-28 pb-20 md:w-[95%]">
            ...
            <div className="flex py-0.5 md:items-end flex-col md:flex-row">
              ...
              <div className="flex flex-col w-1/2">
                ...
                <input
                  ...
                  name="quotation_no"
                  disabled
                  value={metadata.quotation_number}
                  onChange={(e) => {
                    HandelMetadataInput(e);
                  }}
                />
                            ...
                            ([key, value], id) => {
                              return (
                                <div className="md:w-[30%] flex flex-col m-2">
                                  ...
                                  <input
                                    className="mx-1 md:w-[90%] pl-2 text-sm outline-none py-0.5"
                                    name={key}
                ...
                <div className="border-gray-100 border-2 rounded-md px-8 py-4">
                  ...
                  <div className="flex flex-col py-2">
                    ...
                    <select
                      ...
                      className="NewEmployeeinput"
                      onChange={(e) => {
                        HandelRModelSelect(index, element, e);
                      }}
                      defaultValue={element.product || "Select Option"}
                      value={element.product || "Select Option"}
                    >
                                ...
                                <div className="md:w-[30%] flex flex-col m-2">
                                  <div className="ml-2">
                                    <input
                                      ...
                                      defaultChecked={true}
                                      onChange={(e) => {
                                        handelRPOnChecked(index, element, e);
                                      }}
                                    />
                                    <label
                                      className="pl-2 text-sm"
                                  ...
                                  <input
                                    ...
                                    value={element.detailsTobeShown[key]}
                                    onChange={(e) => {
                                      handelChangeRPFieldValue(index, e);
                                    }}
                                  />
                                </div>
                              );
          ...
          <div className="mt-5">
            ...
            <div className="py-1">
              <div className="flex justify-end items-center">
                ...
                <label className="pr-2 text-sm hidden sm:block">
            ...
            {metadata.currency === "USD" ? (
              <>
                <div className="py-1">
                  <div className="flex justify-end items-center">
                    {/* <input
                      className="w-[200px] pl-3 text-sm outline-none py-1 mr-3"
                      type="text"
                      name="custom_field1"
                      value={metadata.custom_field1}
                      onChange={(e) => {
                        HandelMetadataInput(e);
                      }}
                    /> */}
              ...
              <div className="py-1">
                <div className="flex justify-end items-center">
                  <label className="pr-2 text-sm hidden md:block">
                    Transportation Cost
                  </label>
                  <label className="pr-2 text-sm md:hidden">
                    Transport Cost
            ...
            <div className="py-1">
              <div className="flex justify-end items-center">
                ...
                <label className="pr-2 text-sm">{metadata.GST}</label>
                <select
                  id="transportation"
                  name="GST"
                  ...
                  disabled={metadata.currency === "USD"}
          ...
          {Link && (
            ...
            >
              <p>Quotation PDF</p>
              <a href={Link} target="_blank" className="py-2">
                Click here to show pdf
              </a>
            </object>
          )}
