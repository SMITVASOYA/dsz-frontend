...
function Dashbord() {
  ...
  const HandelClickOnDate = (e) => {
    ...
    if (val === "Today") {
      ...
      if (day !== 1) _today.setHours(-24 * (day - 1));
  ...
  return (
    <div className="basis-[100%] pb-20 md:mb-0 md:basis-[83%] flex flex-col bg-bg h-screen">
      <h1 className="text-xl font-medium text-black pt-5 pb-3 pl-3 mt-5 border-b border-gray-400 mx-7">
        DashBoard
      </h1>
      ...
      <div className="w-auto bg-[#ffffffa2] mx-5  md:mx-7 my-6 rounded-lg shadow-sm h-full md:w-auto">
        <div className="text-sm flex justify-start mx-4 mt-3 md:text-base">
          <div className="group">
            <button
              className="text-gray-700 px-2 md:px-5 pt-3 pb-2 focus:text-black focus:font-medium focus:border-b border-blue-500 hover:cursor-pointer focus"
              onClick={(e) => {
                HandelClickOnDate(e);
              }}
            >
          ...
          <div className="group">
            <button
              className="text-gray-700 px-2 md:px-5 pt-3 pb-2 focus:text-black focus:font-medium focus:border-b border-blue-500 hover:cursor-pointer"
              onClick={(e) => {
                HandelClickOnDate(e);
              }}
            >
        ...
        <div className="ml-5 flex flex-col justify-start items-start mt-10 h-[70%] overflow-y-scroll">
          ...
          <div className="flex justify-start flex-wrap">
            {Data.no_of_queries !== undefined &&
              Data.no_of_queries.reverse().map((obj, id) => {
                return (
                  <div
                    className="w-[150px] h-[100px] shadow-md rounded-md flex flex-col justify-center items-center mx-2 my-4 flex-nowrap bg-[#ffffff]"
                    key={id}
                  >
          ...
          <div className="flex justify-start flex-wrap">
            {Data.no_of_clients !== undefined &&
              Data.no_of_clients.reverse().map((obj, id) => {
                return (
                  <div
                    className="w-[150px] h-[100px] shadow-md rounded-md flex flex-col justify-center items-center mx-2 my-4 flex-nowrap bg-[#ffffff]"
                    key={id}
