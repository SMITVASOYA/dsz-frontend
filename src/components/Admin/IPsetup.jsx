      ...
      <div className="pt-5">
        <div className="flex flex-col">
          ...
          <div>
            ...
            />
            <button
              className="px-4 py-1 bg-blue-500 text-white shadow-sm rounded-sm ml-2"
              onClick={() => {
                AddIp();
              }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 py-2">
            {Ips &&
              Ips.map((ip, index) => {
                return (
                  <div
                    className="bg-white shadow-sm rounded-sm flex py-1 px-2 mx-2 my-1"
                    key={index}
                  >
