        ...
        <>
          ...
          <div className="flex flex-col">
            ...
            <input
              className="NewEmployeeinput"
              type="email"
              name="employee_office_email"
              onChange={(e) => {
                HandelEmployeeDetailInput(e);
              }}
              value={Data.employee_office_email}
            />
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:pt-3 md:pb-2">
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="NewEmployeeinput w-full bg-white md:w-[300px]"
                onChange={(e) => {
                  HandelEmployeeDetailInput(e);
                }}
            ...
            <div className="flex flex-col md:flex-row md:justify-start pt-5 md:pb-2">
              <div className="flex items-center">
                <input
                  className="ml-2"
                  type="checkbox"
                  value={Data.employee_isAdmin}
                  name="employee_isAdmin"
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:py-3">
            <div className="flex flex-col">
              ...
              <input
                className="NewEmployeeinput bg-white w-full md:w-[300px]"
                type="date"
                name="employee_doj"
                onChange={(e) => {
                  HandelEmployeeDetailInput(e);
            ...
            <>
              ...
              <div className="flex flex-col">
                ...
                <input
                  className="NewEmployeeinput"
                  type="text"
                  name="employee_name_as_in_bank"
                  onChange={(e) => {
                    HandelBankDetailInput(e);
                  }}
                  value={BankData.employee_name_as_in_bank}
                />
              </div>
              <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <input
                  className="NewEmployeeinput"
                  type="text"
                  name="bank_info_branch_name"
                  onChange={(e) => {
                    HandelBankDetailInput(e);
                  }}
                  value={BankData.bank_info_branch_name}
                />
              </div>
              <div className="flex flex-col">
                ...
                <input
                  ...
                  value={BankData.bank_account_no}
                />
              </div>
              <div className="flex flex-col">
                ...
                <input
                  className="NewEmployeeinput"
                  type="text"
                  name="bank_info_ifsc_code"
                  onChange={(e) => {
                    HandelBankDetailInput(e);
                  }}
                  value={BankData.bank_info_ifsc_code}
                />
              </div>

              <div>
                <button
                  className="pb-10 md:pb-2 py-2 px-6 mt-10 bg-green-500 text-white font-medium rounded-md shadow-sm "
                  onClick={() => {
                    handelSubmitAddBankInfo();
                  }}
                >
                  Submit
                </button>
